...
public class NoteController {
    ...
    @ResponseBody
    public List<NoteDto> getTicketsNotes(@NotNull @PathVariable(value="ticketId") Long ticketId){
    ...
    @ResponseBody
    public NoteDto getNote(@NotNull @PathVariable(value="id") Long noteId){
...
/*
    ...
    @ResponseBody
    public NoteDto createNote(@Valid @RequestBody NoteDto note){
    ...
    public void deleteNote(@NotNull @PathVariable(value="id") Long noteId){
